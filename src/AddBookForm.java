...
public class AddBookForm extends JInternalFrame {
 ...
 public AddBookForm() {
  ...
  addBookNotesPanel.setBorder(new TitledBorder(null, "\u03A3\u03B7\u03BC\u03B5\u03B9\u03CE\u03C3\u03B5\u03B9\u03C2", TitledBorder.LEADING, TitledBorder.TOP, null, null));
   ...
   groupLayout.createParallelGroup(Alignment.TRAILING)
    .addGroup(groupLayout.createSequentialGroup()
     ...
     .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
      .addComponent(addBookNotesPanel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
      .addComponent(panelData, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE))
     .addContainerGap())
  );
  groupLayout.setVerticalGroup(
   groupLayout.createParallelGroup(Alignment.LEADING)
    .addGroup(groupLayout.createSequentialGroup()
     .addContainerGap()
     .addComponent(panelData, GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE)
     .addPreferredGap(ComponentPlacement.UNRELATED)
     .addComponent(addBookNotesPanel, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
     .addContainerGap())
  );
  ...
  panelData.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{bookNamelLabel, bookNameTextField, bookAuthorLabel, bookAuthorTextField, bookSubjectLabel, bookSubjectTextField, bookPagesLabel, bookPagesTextField, bookPublisherLabel, bookPublisherTextField, bookEditionLabel, bookEditionTextField, bookLanguageLabel, bookLanguageComboBox, addBookButton, cancelButton}));
  ...
  gl_addBookNotesPanel.setHorizontalGroup(
   gl_addBookNotesPanel.createParallelGroup(Alignment.LEADING)
    .addGroup(gl_addBookNotesPanel.createSequentialGroup()
     .addContainerGap()
     .addComponent(addbookNotesTextPane, GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE)
     .addContainerGap())
  );
  gl_addBookNotesPanel.setVerticalGroup(
   gl_addBookNotesPanel.createParallelGroup(Alignment.LEADING)
    .addGroup(gl_addBookNotesPanel.createSequentialGroup()
     .addComponent(addbookNotesTextPane, GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
     .addContainerGap())
  );
