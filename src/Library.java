...
public class Library extends JFrame {
	...
	private JMenuItem exitJMenuItem, addBookJMenuItem, popularBookJMenuItem, addMemberJMenuItem, bannedMemberJÌenuItem, borrowBookJMenuItem, returnBookJMenuItem, searchJMenuItem;
	private JToolBar toolBar;
	private JButton btnAddBook,btnPopularBook, btnAddMember, btnBannedMember, btnBorrowBook, btnReturnBook, btnSearch;
	...
	private void initComponents() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Library.class.getResource("/images/Library_Folder_64x64.png")));
		...
		exitJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/exit_16x16.png")));
		...
		addBookJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/add_book_16x16.png")));
		booksJMenu.add(addBookJMenuItem);

		popularBookJMenuItem = new JMenuItem("\u0394\u03B7\u03BC\u03BF\u03C6\u03B9\u03BB\u03AE \u0392\u03B9\u03B2\u03BB\u03AF\u03B1");
		popularBookJMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, InputEvent.CTRL_MASK));
		popularBookJMenuItem.addActionListener(new PopularBooksActionListener());
		popularBookJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/chart_arrow_16x16.png")));
		booksJMenu.add(popularBookJMenuItem);

		/*JMenuItem listBookJMenuItem = new JMenuItem("\u039B\u03AF\u03C3\u03C4\u03B1 \u0392\u03B9\u03B2\u03BB\u03AF\u03C9\u03BD");
		...
		addMemberJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/user_add_16x16.png")));
		membersJMenu.add(addMemberJMenuItem);

		bannedMemberJÌenuItem = new JMenuItem("\u0391\u03C3\u03C5\u03BD\u03B5\u03C0\u03B5\u03AF\u03C2 \u03A7\u03C1\u03AE\u03C3\u03C4\u03B5\u03C2");
		bannedMemberJÌenuItem.addActionListener(new BannedMembersActionListener());
		bannedMemberJÌenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/user_ban_16x16.png")));
		membersJMenu.add(bannedMemberJÌenuItem);

		/*JMenuItem listMemberJMenuItem = new JMenuItem("\u039B\u03AF\u03C3\u03C4\u03B1 \u039C\u03B5\u03BB\u03CE\u03BD");
		membersJMenu.add(listMemberJMenuItem);*/

		JMenu loanJMenu = new JMenu("\u0394\u03B1\u03BD\u03B5\u03B9\u03C3\u03BC\u03CC\u03C2");
		...
		borrowBookJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/inbox_upload_16x16.png")));
		loanJMenu.add(borrowBookJMenuItem);

		returnBookJMenuItem = new JMenuItem("\u0395\u03C0\u03B9\u03C3\u03C4\u03C1\u03BF\u03C6\u03AE \u0392\u03B9\u03B2\u03BB\u03AF\u03BF\u03C5");
		returnBookJMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.CTRL_MASK));
		returnBookJMenuItem.addActionListener(new ReturnBookActionListener());
		returnBookJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/inbox_download_16x16.png")));
		loanJMenu.add(returnBookJMenuItem);

		JMenu searchJMenu = new JMenu("\u0391\u03BD\u03B1\u03B6\u03AE\u03C4\u03B7\u03C3\u03B7");
		...
		searchJMenuItem.setIcon(new ImageIcon(Library.class.getResource("/images/search_16x16.png")));
		searchJMenu.add(searchJMenuItem);

		JMenu helpJMenu = new JMenu("\u0392\u03BF\u03AE\u03B8\u03B5\u03B9\u03B1");
		menuBar.add(helpJMenu);

		JMenu mnAboutJMenu = new JMenu("About");
		mnAboutJMenu.setIcon(new ImageIcon(Library.class.getResource("/images/about_16x16.png")));
		helpJMenu.add(mnAboutJMenu);

		JMenuItem mntmCopyrightJMenuItem = new JMenuItem("copyright \u00A9 2015 Gaitanidis");
		...
		btnAddBook.setToolTipText("\u03A0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7 \u0392\u03B9\u03B2\u03BB\u03AF\u03BF\u03C5");
		btnAddBook.setIcon(new ImageIcon(Library.class.getResource("/images/add_book_16x16.png")));
		toolBar.add(btnAddBook);

		btnPopularBook = new JButton("");
		btnPopularBook.addActionListener(new PopularBooksActionListener());
		btnPopularBook.setIcon(new ImageIcon(Library.class.getResource("/images/chart_arrow_16x16.png")));
		btnPopularBook.setToolTipText("\u0394\u03B7\u03BC\u03BF\u03C6\u03B9\u03BB\u03AE \u0392\u03B9\u03B2\u03BB\u03AF\u03B1");
		toolBar.add(btnPopularBook);
		toolBar.addSeparator();

		btnAddMember = new JButton("");
		btnAddMember.addActionListener(new AddMemberActionListener());
		btnAddMember.setToolTipText("\u03A0\u03C1\u03BF\u03C3\u03B8\u03AE\u03BA\u03B7 \u039C\u03AD\u03BB\u03BF\u03C5\u03C2");
		btnAddMember.setIcon(new ImageIcon(Library.class.getResource("/images/user_add_16x16.png")));
		toolBar.add(btnAddMember);

		btnBannedMember = new JButton("");
		btnBannedMember.addActionListener(new BannedMembersActionListener());
		btnBannedMember.setToolTipText("\u0391\u03C3\u03C5\u03BD\u03B5\u03C0\u03B5\u03AF\u03C2 \u03A7\u03C1\u03AE\u03C3\u03C4\u03B5\u03C2");
		btnBannedMember.setIcon(new ImageIcon(Library.class.getResource("/images/user_ban_16x16.png")));
		...
		btnReturnBook.setIcon(new ImageIcon(Library.class.getResource("/images/inbox_download_16x16.png")));
		...
		gl_contentPane.setHorizontalGroup(
				...
				.addComponent(toolBar, GroupLayout.DEFAULT_SIZE, 874, Short.MAX_VALUE)
				.addComponent(desktopPane, GroupLayout.DEFAULT_SIZE, 874, Short.MAX_VALUE)
				);
		gl_contentPane.setVerticalGroup(
				...
				.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addComponent(desktopPane, GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE))
				);
	...
	class PopularBooksActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(null, 
					"ÅìöÜíéóç ôùí Äçìïöéëþí Âéâëßùí áíÜ ìÞíá", 
					"ÄçìïöéëÞ Âéâëßá",
