...
public class MemberBookTableModel extends AbstractTableModel {
	...
	public String getColumnName(int column) {
		String[] columnNames=new String[]{"Κωδικός Δανεισμού", "Ημέρα Δανεισμού", "Ημέρα Παράδοσης", "Ημέρα Επιστροφής", "ISBN", "Αριθμός Μητρώου"};
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		Object[] values=new Object[]{
				mb.getBorrowID(),mb.getBorrowDay(),mb.getReturnDay(),mb.getDeliveryDay(),mb.getBook().getiSBN(),mb.getMember().getiD()
		};
