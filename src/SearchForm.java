...
public class SearchForm extends JInternalFrame {
	...
	class SearchBookActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (books.isEmpty()){
				JOptionPane.showMessageDialog(null,
						"Το βιβλίο που αναζητήσατε δεν υπαρχεί.", "Λάθος λέξη κλειδί",
	...
	class SearchMemberActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (members.isEmpty()){
				JOptionPane.showMessageDialog(null,
						"Το μέλος που αναζητήσατε δεν υπαρχεί.", "Λάθος λέξη κλειδί",
						JOptionPane.INFORMATION_MESSAGE);
	...
	// Search table "Δανεισμοί" with the key word given
	class BorrowSearchActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			// Searching at the table "Δανεισμοί"
			...
			if (mbooks.isEmpty()){
				JOptionPane.showMessageDialog(null,
						"Δεν υπάρχει δανεισμός με τη συγκεκριμένη τιμή.", "Κανένας Δανεισμός",
						JOptionPane.INFORMATION_MESSAGE);
				borrowKeyWordTextField.setText(null);
			}
